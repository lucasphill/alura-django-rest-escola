...
class EstudantesTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.usuario = User.objects.get(username='lucas')
        self.url = reverse('Estudantes-list')
        self.client.force_authenticate(user=self.usuario)
        self.estudante_01 = User.objects.get(pk=94)
        self.estudante_02 = User.objects.get(pk=92)
